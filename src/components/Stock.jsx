...
*/
  ...
  const numericalChange = Math.round(currentPrice - prevClosingPrice);

  const rateChange = ((currentPrice - prevClosingPrice) / prevClosingPrice) * 100;

  const calcRateChange = rateChange.toFixed(2)
